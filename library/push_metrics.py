...
options:
    ...
    conf_url:
        description:
            - url address of confluence ie https://confluence.corp.domain.ca/rest/api/content/.
        required: True
        type: String
    conf_page_id:
        description:
...
- name: Call the module to get prometheus metrics
  push_metrics:
    ...
    conf_url: 'https://confluence.corp.domain.ca/rest/api/content/'
    conf_id: '87191234'
